#pragma checksum "C:\Users\JakeHershberger\Desktop\CODE\shareABite2.0\ShareABite2\Views\Shared\_loggedin.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "39e1d0f6a1602d3de490e2050166dff414121bb4"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"39e1d0f6a1602d3de490e2050166dff414121bb4", @"/Views/Shared/_loggedin.cshtml")]
...
#line 17 "C:\Users\JakeHershberger\Desktop\CODE\shareABite2.0\ShareABite2\Views\Shared\_loggedin.cshtml"
               Write(UserManager.GetUserName(User));

#line default
#line hidden
            EndContext();
            BeginContext(585, 503, true);
            WriteLiteral(@"! </h1>
...
#line 43 "C:\Users\JakeHershberger\Desktop\CODE\shareABite2.0\ShareABite2\Views\Shared\_loggedin.cshtml"
                Write(UserManager.GetUserId(User));

#line default
#line hidden
            EndContext();
            BeginContext(1116, 4390, true);
            WriteLiteral(@"'
	...
	function loadCommunityRecipes() {
		var settings = {
			""async"": true,
			""crossDomain"": true,
			""url"": ""/api/Recipe/MostRecentRecipes"",
			""method"": ""GET"",
			""headers"": {
	...
	function loadUserRecipes(userIdN");
            WriteLiteral(@"umber) {
		var settings = {
			""async"": true,
			""crossDomain"": true,
			""url"": ""/api/Recipe/MyMostRecentRecipes?userInfo="" + userIdNumber,
			""method"": ""GET"",
			""headers"": {
				""cache-control"": ""no-cache"",
			}
		...
		$.ajax(settings).done(function (response) {
			...
			$(response).each(function (ind, val) {
				$('#myRecentRecipes').append('<div class=""col-sm-4 recipe""><h3>' + val.recipeName + '</h3>' +
					...
					'<div class=""row recipe-footer"">' +
					'<di");
            WriteLiteral(@"v class=""col-sm-4 recipe-footer-share"">' +
					//edit
					'<a class=""col-sm-6"" href=""/Recipe/Edit/' + val.recipeId + '"" target=""_blank"">' +
					'<span class=""glyphicon glyphicon-edit"" aria-hidden=""true""></span>' +
					'</a>' +
