#pragma checksum "C:\Users\Acer_Aspire\Desktop\Code_repo\shareABite2.0\ShareABite2\Views\Shared\_loggedin.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e349875af67dc7caebb54d1ee2c86a6cf50bab9a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e349875af67dc7caebb54d1ee2c86a6cf50bab9a", @"/Views/Shared/_loggedin.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "c3a8998782c041d895959a883cadc3d9", async() => {
            }
            );
		...
		$.ajax(settings).done(function (response) {
			...
			$(response).each(function (ind, val) {
				$('#myRecentRecipes').append('<div class=""col-sm-4 recipe""><h3>' + val.recipeName + '</h3>' +
					...
					//display view, edit, and share btns
					'<div");
            WriteLiteral(@" class=""row recipe-footer"">' +
					'<div class=""col-sm-4 recipe-footer-share"">' +
					//edit
					'<a class=""col-sm-6"" href=""/Recipe/Edit/' + val.recipeId + '"" target=""_blank"">' +
					'<span class=""glyphicon glyphicon-edit"" aria-hidden=""true""></span>' +
	...
	function readMoreDisplay() {
		$('.recipe-story').each(function (ind, val) {
			...
			if (storyLength > 200) {
				...
				$(val).html(story + "" <a href='/view/recipe/"" + Rec");
            WriteLiteral("ipeId + \"\'>Read More...</a>\")\r\n\t\t\t} else {\r\n\t\t\t\t$(val).html(story)\r\n\t\t\t}\r\n\t\t})\r\n\t}\r\n</script>\r\n\r\n ");
            EndContext();
        }
