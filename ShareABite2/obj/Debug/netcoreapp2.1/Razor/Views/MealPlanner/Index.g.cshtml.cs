#pragma checksum "C:\Users\JakeHershberger\Desktop\CODE\shareABite2.0\ShareABite2\Views\MealPlanner\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6d72ab8ca9d855471318711eeb106f0a805451b3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6d72ab8ca9d855471318711eeb106f0a805451b3", @"/Views/MealPlanner/Index.cshtml")]
...
<script>
		...
		function generateRecipeDisplay() {
            ...
            WriteLiteral(@"cipe"") {
					...
					if (x !== ""ChooseNewRecipe"") {
						$.get(""/api/Recipe/UserRecipes"" + x, function (data) {
						...
						randomNumber()
						if (x !== ""ChooseNewRecipe"") {
							$(val).$.get(""/api/Recipe/UserRecipes"" + x, function (data) {
								buildDisplay(data, val, i)
							})
						} else {
						}
	...
	function randomNumber() {
		var randomNumber = Math.f");
            WriteLiteral(@"loor(Math.random() * savedRecipes)
