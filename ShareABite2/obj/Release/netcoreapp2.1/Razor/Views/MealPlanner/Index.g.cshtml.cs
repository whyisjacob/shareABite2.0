#pragma checksum "C:\Users\Acer_Aspire\Desktop\Code_repo\shareABite2.0\ShareABite2\Views\MealPlanner\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1972e78d73c16a9be99d85d508d5f272bfd6123e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1972e78d73c16a9be99d85d508d5f272bfd6123e", @"/Views/MealPlanner/Index.cshtml")]
...
function buildDisplay(data) {
	...
	data.forEach(function (recipe) {
		$(""#mealDisplay_"" + count).html(""<strong>"" + recipe.recipeName + ""</strong> <div class='meal_planner_img' style='background-image:url("" + recipe.imgUrl + "")'></div><p><img width='20px' src='images/clock.png' alt='Total Prep and Cook Time' class='directions_image_mp'> "" + recipe.cookTime + "" minutes<br><img width='20px' src='images/servings.png");
            WriteLiteral(@"' alt='Servings' class='directions_image_mp'> "" + recipe.servings + "" servings</p> <a href='/view/recipe/"" + recipe.recipeId + ""' target='_blank'>View Recipe</a>"");
